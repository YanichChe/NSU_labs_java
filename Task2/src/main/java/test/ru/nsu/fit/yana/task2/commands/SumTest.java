...
import ru.nsu.fit.yana.task2.commands.Sum;
...
class SumTest
{
    ...
    {
        return Stream.of(
                Arguments.of(new String[]{Command.SUM}, new ArrayList<>(List.of(4.0, 8.0))),
                Arguments.of(new String[]{Command.SUM}, new ArrayList<>(List.of(89.0, 55555.0))),
                Arguments.of(new String[]{Command.SUM}, new ArrayList<>(List.of(66.78, -369878.87)))
        );
    }
    ...
    {
        return Stream.of(
                Arguments.of(new String[]{Command.SUM}, new ArrayList<>(List.of(8.0)), EmptyStackException.class)
        );
    }
}